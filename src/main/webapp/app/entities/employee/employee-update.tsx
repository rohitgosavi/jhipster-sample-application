          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="empoloyeeIdLabel" for="empoloyeeId">
                    Empoloyee Id
                  </Label>
                  <AvField id="employee-empoloyeeId" type="string" className="form-control" name="empoloyeeId" />
                </AvGroup>
                <AvGroup>
                  <Label id="empoloyeeNameLabel" for="empoloyeeName">
                    Empoloyee Name
                  </Label>
                  <AvField id="employee-empoloyeeName" type="text" name="empoloyeeName" />
                </AvGroup>
